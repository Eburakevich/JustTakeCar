...
class CarCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView!.register(CarCollectionViewCell.self, forCellWithReuseIdentifier: "CarCollectionViewCell")
